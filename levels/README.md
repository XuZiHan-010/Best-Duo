...
| [第 5 关](level-05.md) | ★ | 区 3 偶数 + 区 5 总和 16-20 + 区 6 至少一对同值 | 已设计 |
| [第 6 关](level-06.md) | ★ | 区 2 总和 9 + 区 4 恰好 2 张 + 区 6 恰好 3 张且至少一黑一白 | 已设计 |
| [第 7 关](level-07.md) | ★★ | 区 3 恰好一黑一白 + 区 5 奇数 + 区 6 总和 22-24 | 已设计 |
| [第 8 关](level-08.md) | ★★ | 区 2 总和 8-12 + 区 4/5 总和差 ≤ 3 + 区 6 至少 2 张白牌 | 已设计 |
| [第 9 关](level-09.md) | ★★ | 区 1 总和 6 + 区 6 恰好 3 张、数值不同、2 黑 1 白 | 已设计 |
| [第 10 关](level-10.md) | ★★ | 区 2 总和 10 + 区 3 偶数 + 区 4 一黑一白 + 区 5/6 总和差 ≤ 4 | 已设计 |
| [第 11 关](level-11.md) | ★★★ | 区 1 唯一最接近 6 + 区 2 只能白且至少 2 张 + 区 4 至少 1 黑 1 白 + 区 6 恰好 2 张 | 已设计 |
| [第 12 关](level-12.md) | ★★★ | 区 1、3、5 不能放数值 1/2/3，沿用递增和 24 点上限 | 已设计 |
| …… | | 后续关卡待补充 | 待补 |
